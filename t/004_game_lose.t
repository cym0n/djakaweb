...
diag("Waiting...");
    sleep 7;
diag("Losing scenario");
    response_redirect_location_is ['GET' => '/game/click'], 'http://localhost/game/gameover';
    $game = schema->resultset("Game")->find($game->id);
    is $game->active, -1, "The game is in the correct failed status";
    is $game->danger, 130, "Danger is 130";
    $active_action = $game->get_active_action();
